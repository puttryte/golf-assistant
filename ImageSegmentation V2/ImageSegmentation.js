...
{ 
    ...
    image.onload = function()
    {
        ...
        if(segments.length == 1)
        {
            ...
            ShowHoughCircle(tempCtx, tempCtx, segments[0], peaks1, Math.round((segments[0].height) / 4));
            ShowHoughLines(tempCtx, tempCtx, segments[0], peaks2);
        }
        else if(segments.length == 2)
        {
            ...
            ShowHoughCircle(tempCtx, tempCtx, segments[0], peaks1, Math.round((segments[0].height) / 2));
            ShowHoughLines(tempCtx, tempCtx, segments[1], peaks2);
        }
        else if(segments.length > 2)
        {
